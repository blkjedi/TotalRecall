...
// console.log(
//   `That boy Tom out here looking fresh with the ${thomsCloset[0][0]}, the ${thomsCloset[1][1]} and the ${thomsCloset[2][2]}`
// );
...
const result1 = calculateCube (2);
console.log(`${result1} is the result`);
